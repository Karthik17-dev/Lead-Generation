...
const ENVIRONMENTS = {
  preview: {
    canonicalHost: 'dev.zed.com',
    ecsHost: 'preview.zed.com',
    apiHost: 'dev-api.zed.com',
    protected: true,
  },
  dev: {
    canonicalHost: 'dev.zed.com',
  ...
  staging: {
    canonicalHost: 'staging.zed.com',
    ecsHost: 'staging-fe-ecs.zed.com',
    apiHost: 'staging-api.zed.com',
    protected: true,
  },
  prod: {
    canonicalHost: 'zed.com',
    ecsHost: 'prod-fe-ecs.zed.com',
    apiHost: 'api.zed.com',
    protected: false,
  },
};
...
const OPTIONAL_KEYS = [
  ...
  'NEXT_PUBLIC_GTM_ID',
  'NEXT_PUBLIC_ZED_ENV',
  'NEXT_PUBLIC_ZED_PERSONAL_CONTACT',
...
export function renderWebEnvironment(name, environment = process.env) {
  ...
  const payload = {
    ...
    ZED_PUBLIC_APP_URL: appUrl,
    ZED_PUBLIC_BACKEND_URL: backendUrl,
    ZED_PUBLIC_SUPABASE_URL: required(environment, 'NEXT_PUBLIC_SUPABASE_URL'),
    ZED_PUBLIC_SUPABASE_ANON_KEY: required(environment, 'NEXT_PUBLIC_SUPABASE_ANON_KEY'),
