...
Every fact here traces to `suna/MANIFESTO.md` and `suna/README.md`. No invented metrics, customers,
...
- 20,000+ GitHub stars on `karthikxa/AI-Management-System`. Cite the number, never "the go-to" or "the leading."
...
- **Suna** — the open-source repository the platform lives in (`karthikxa/AI-Management-System`). In outward copy, prefer **Zed** alone unless you specifically mean the repo.
