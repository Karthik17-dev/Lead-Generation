...
describe('deployed staging smoke', () => {
  it('accepts only the exact staging API, web, gateway, and source SHA', () => {
    expect(
      resolveTargetSmokeConfig({
        KE2E_API_URL: 'https://staging-api.zed.com/v1/',
        E2E_BASE_URL: 'https://staging.zed.com/',
        KE2E_GATEWAY_URL: 'https://gateway-staging.zed.com/',
        KE2E_EXPECT_SHA: SHA,
      }),
    ).toEqual({
      apiUrl: 'https://staging-api.zed.com/v1',
      webUrl: 'https://staging.zed.com',
  ...
  it.each([
    ['production API', { KE2E_API_URL: 'https://api.zed.com/v1' }],
    ['development API', { KE2E_API_URL: 'https://dev-api.zed.com/v1' }],
    ['production web', { E2E_BASE_URL: 'https://zed.com' }],
    ['development gateway', { KE2E_GATEWAY_URL: 'https://gateway-dev.zed.com' }],
