...
function runtimeSecrets(): PreviewRuntimeSecrets {
  return {
    ...
    ZED_GITHUB_APP_ID: value('ZED_GITHUB_APP_ID'),
    ZED_GITHUB_APP_PRIVATE_KEY: value('ZED_GITHUB_APP_PRIVATE_KEY'),
    ZED_GITHUB_APP_SLUG: value('ZED_GITHUB_APP_SLUG'),
...
const repository = value('GITHUB_REPOSITORY', 'karthikxa/AI-Management-System');
const platinum = {
