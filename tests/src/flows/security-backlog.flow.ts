...
flow(
  ...
  async (ctx) => {
    const secretPattern =
      /(postgres(?:ql)?:\/\/|DATABASE_URL|SUPABASE_SERVICE_ROLE_KEY|INTERNAL_SERVICE_KEY|STRIPE_SECRET_KEY|OPENAI_API_KEY|ANTHROPIC_API_KEY|zed_(?:pat|sa|sb|tnl)_[A-Za-z0-9]{8,}|sk-[A-Za-z0-9]{20,}|eyJ[A-Za-z0-9_-]{30,}\.)/i;
