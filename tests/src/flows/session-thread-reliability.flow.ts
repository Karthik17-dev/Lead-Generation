 ...
 * apps/zed-sandbox-agent-server/src/main.ts and
 ...
 *
 * There is no Zed-level session-scoped abort route (confirmed against
 ...
 * DIFFERENT call: server-to-daemon `POST {sandbox}/zed/abort`, HMAC-signed,
