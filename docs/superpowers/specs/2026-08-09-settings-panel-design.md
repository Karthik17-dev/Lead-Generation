...
Branch `settings`, worktree `/Users/jay/root/zed/suna-settings`. The user
...
Zed has three separate settings surfaces. They hold overlapping content, use
...
Cursor is the nearest analogue to Zed on Mobbin: an agent product with
