...
```sh
curl -fsSL https://raw.githubusercontent.com/karthikxa/AI-Management-System/main/scripts/zed-selfhost-up.sh \
...
```hcl
module "zed_selfhost" {
  source = "github.com/karthikxa/AI-Management-System//infra/terraform/modules/selfhost-ec2"
...
> human runs the
> [`Promote Self-Host Stable`](https://github.com/karthikxa/AI-Management-System/actions/workflows/promote-self-host-stable.yml)
