...
# Prefer build:bundles when the package declares one (today: @zed/sdk,
# which also emits the tsup browser bundles — dist/zed.esm.min.js and
...
# Packages with no CDN bundle (@zed/llm-catalog, @zed/executor-sdk) have
