...
#
#   curl -fsSL https://raw.githubusercontent.com/karthikxa/AI-Management-System/main/scripts/zed-selfhost-up.sh | bash -s -- --domain zed.example.com --email ops@example.com
