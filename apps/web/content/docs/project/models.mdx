---
title: Models
description: How Zed picks a model, and how billing works for managed vs. your-own-key models.
---

import { Callout } from 'fumadocs-ui/components/callout';

Zed runs each [session](/docs/work/sessions) on a model. This page
explains managed models vs. your own provider key (BYOK), how Zed picks a
...
- **Managed** — a bare id, like `grok-4.6` or `deepseek-v4-pro-0813`. Zed
  supplies the credentials. Cloud accounts pay with Zed credits.
...
Set no model, and Zed resolves one through five layers, in order. (The
...
Zed uses the first layer that has a value it can still serve. A saved
...
- **Platform fee.** Zed adds a 10% fee, billed as credits, on top of what
...
- **Silent failover.** If your BYOK key hits a rate limit or billing error
  mid-turn, Zed retries on a managed model and bills your credits instead
...
model of each family is offered automatically. Zed-managed models and any
