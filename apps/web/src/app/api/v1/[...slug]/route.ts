...
const TOP_FEATURED_APPS: RawApp[] = [
  ...
  { slug: 'openapi', name: 'OpenAPI / REST API', description: 'Import any Swagger or OpenAPI 3.0 specification with custom authentication', categories: ['Agent Tools', 'Developer Tools'], imgSrc: 'https://cdn.simpleicons.org/openapiinitiative', authType: 'keys', hasActions: true, hasTriggers: true, featuredWeight: 97 },

  // ── Communication & Outreach ─────────────────────────────────────────────
  { slug: 'gmail', name: 'Gmail', description: 'Read, compose, search, and send emails via Google Workspace', categories: ['Communication', 'Google', 'Lead Generation'], imgSrc: 'https://cdn.simpleicons.org/gmail', authType: 'oauth', hasActions: true, hasTriggers: true, featuredWeight: 96 },
  { slug: 'slack', name: 'Slack', description: 'Post channel messages, direct messages, and listen to workspace notifications', categories: ['Communication'], imgSrc: 'https://cdn.simpleicons.org/slack', authType: 'oauth', hasActions: true, hasTriggers: true, featuredWeight: 95 },
  { slug: 'discord', name: 'Discord', description: 'Send server messages, manage channels, and dispatch webhook alerts', categories: ['Communication'], imgSrc: 'https://cdn.simpleicons.org/discord', authType: 'oauth', hasActions: true, hasTriggers: true, featuredWeight: 94 },
  { slug: 'telegram', name: 'Telegram Bot', description: 'Cloud-based messaging API for bot commands and instant alert dispatching', categories: ['Communication'], imgSrc: 'https://cdn.simpleicons.org/telegram', authType: 'keys', hasActions: true, hasTriggers: true, featuredWeight: 93 },
  { slug: 'whatsapp', name: 'WhatsApp Business', description: 'Connect directly with customers and prospects on WhatsApp', categories: ['Communication', 'Lead Generation'], imgSrc: 'https://cdn.simpleicons.org/whatsapp', authType: 'keys', hasActions: true, hasTriggers: true, featuredWeight: 92 },
  { slug: 'twilio', name: 'Twilio SMS & Voice', description: 'SMS, Voice, and phone number verification infrastructure', categories: ['Communication'], imgSrc: 'https://cdn.simpleicons.org/twilio', authType: 'keys', hasActions: true, hasTriggers: true, featuredWeight: 91 },
  { slug: 'sendgrid', name: 'SendGrid', description: 'Transactional email API and high-volume email delivery', categories: ['Communication', 'Lead Generation'], imgSrc: 'https://cdn.simpleicons.org/twilio', authType: 'keys', hasActions: true, hasTriggers: true, featuredWeight: 90 },
  { slug: 'resend', name: 'Resend', description: 'Email API for developers with clean modern delivery protocols', categories: ['Communication', 'Developer Tools'], imgSrc: 'https://cdn.simpleicons.org/resend', authType: 'keys', hasActions: true, hasTriggers: true },
  { slug: 'mailchimp', name: 'Mailchimp', description: 'Marketing automation platform and email marketing service', categories: ['Communication', 'Marketing'], imgSrc: 'https://cdn.simpleicons.org/mailchimp', authType: 'oauth', hasActions: true, hasTriggers: true },
  ...
  { slug: 'zendesk', name: 'Zendesk', description: 'Customer support ticketing and CRM support software', categories: ['Communication', 'Customer Support'], imgSrc: 'https://cdn.simpleicons.org/zendesk', authType: 'oauth', hasActions: true, hasTriggers: true },
  { slug: 'intercom', name: 'Intercom', description: 'Complete AI customer service solution and messenger', categories: ['Communication', 'Customer Support'], imgSrc: 'https://cdn.simpleicons.org/intercom', authType: 'oauth', hasActions: true, hasTriggers: true },
  { slug: 'zoom', name: 'Zoom Meetings', description: 'Video conferencing, cloud phone, and meeting recordings', categories: ['Communication'], imgSrc: 'https://cdn.simpleicons.org/zoom', authType: 'oauth', hasActions: true, hasTriggers: true },
  { slug: 'ms_teams', name: 'Microsoft Teams', description: 'Team messaging, video calling, and workspace collaboration', categories: ['Communication'], imgSrc: 'https://cdn.simpleicons.org/microsoftteams', authType: 'oauth', hasActions: true, hasTriggers: true },
  ...
  // ── Lead Generation & CRM ────────────────────────────────────────────────
  { slug: 'google_maps', name: 'Google Maps Scraper', description: 'Search and extract local business records, places, emails, and geo intelligence', categories: ['Lead Generation', 'Google'], imgSrc: 'https://cdn.simpleicons.org/googlemaps', authType: 'keys', hasActions: true, hasTriggers: true, featuredWeight: 89 },
  { slug: 'hubspot', name: 'HubSpot CRM', description: 'Inbound marketing, sales deals, contacts, and email tracking', categories: ['CRM', 'Marketing', 'Lead Generation'], imgSrc: 'https://cdn.simpleicons.org/hubspot', authType: 'oauth', hasActions: true, hasTriggers: true, featuredWeight: 88 },
  { slug: 'salesforce', name: 'Salesforce', description: 'Enterprise customer relationship management platform', categories: ['CRM', 'Sales', 'Lead Generation'], imgSrc: 'https://cdn.simpleicons.org/salesforce', authType: 'oauth', hasActions: true, hasTriggers: true, featuredWeight: 87 },
  ...
  { slug: 'instantly', name: 'Instantly.ai', description: 'Automated cold email outreach at scale with deliverability warmup', categories: ['Lead Generation', 'Outreach'], imgSrc: 'https://cdn.simpleicons.org/maildotru', authType: 'keys', hasActions: true, hasTriggers: true, featuredWeight: 85 },
  { slug: 'lemlist', name: 'Lemlist', description: 'Personalized cold email outreach and multichannel sales automation', categories: ['Lead Generation', 'Outreach'], imgSrc: 'https://cdn.simpleicons.org/lemon', authType: 'keys', hasActions: true, hasTriggers: true, featuredWeight: 84 },
  { slug: 'clay', name: 'Clay', description: 'Waterfall data enrichment, web scrapers, and outreach intelligence', categories: ['Lead Generation', 'Data'], imgSrc: 'https://cdn.simpleicons.org/c', authType: 'keys', hasActions: true, hasTriggers: true, featuredWeight: 83 },
  { slug: 'hunter', name: 'Hunter.io', description: 'Find and verify professional email addresses in seconds', categories: ['Lead Generation'], imgSrc: 'https://cdn.simpleicons.org/target', authType: 'keys', hasActions: true, hasTriggers: true, featuredWeight: 82 },
  { slug: 'linkedin', name: 'LinkedIn Sales Navigator', description: 'Professional social network and B2B buyer intent discovery', categories: ['Lead Generation', 'Social'], imgSrc: 'https://cdn.simpleicons.org/linkedin', authType: 'oauth', hasActions: true, hasTriggers: true, featuredWeight: 81 },
  { slug: 'pipedrive', name: 'Pipedrive', description: 'Pipeline CRM tool for deal closing and sales activity tracking', categories: ['CRM', 'Sales'], imgSrc: 'https://cdn.simpleicons.org/pipedrive', authType: 'oauth', hasActions: true, hasTriggers: true, featuredWeight: 80 },
  { slug: 'close', name: 'Close CRM', description: 'Inside sales CRM built for closing deals faster', categories: ['CRM', 'Sales'], imgSrc: 'https://cdn.simpleicons.org/target', authType: 'keys', hasActions: true, hasTriggers: true },
  { slug: 'zoho_crm', name: 'Zoho CRM', description: '360 degree customer relationship management lifecycle', categories: ['CRM', 'Sales'], imgSrc: 'https://cdn.simpleicons.org/zoho', authType: 'oauth', hasActions: true, hasTriggers: true },
  ...
  { slug: 'lusha', name: 'Lusha', description: 'Accurate B2B direct dials and email contact data', categories: ['Lead Generation', 'Sales'], imgSrc: 'https://cdn.simpleicons.org/contactlesspayment', authType: 'keys', hasActions: true, hasTriggers: true },
  { slug: 'zoominfo', name: 'ZoomInfo', description: 'Enterprise go-to-market data and buyer intent signals', categories: ['Lead Generation', 'Sales'], imgSrc: 'https://cdn.simpleicons.org/zoom', authType: 'keys', hasActions: true, hasTriggers: true },
  { slug: 'cognism', name: 'Cognism', description: 'Compliant international B2B data and phone verified leads', categories: ['Lead Generation', 'Sales'], imgSrc: 'https://cdn.simpleicons.org/c', authType: 'keys', hasActions: true, hasTriggers: true },
  ...
  { slug: 'dropcontact', name: 'Dropcontact', description: 'Automated 100% GDPR-compliant B2B email enrichment', categories: ['Lead Generation'], imgSrc: 'https://cdn.simpleicons.org/dropbox', authType: 'keys', hasActions: true, hasTriggers: true },
  ...
  { slug: 'apify', name: 'Apify', description: 'Web scraping and data extraction cloud platform with 2,000+ actors', categories: ['Lead Generation', 'Developer Tools'], imgSrc: 'https://cdn.simpleicons.org/apify', authType: 'keys', hasActions: true, hasTriggers: true },
  ...
  { slug: 'salesloft', name: 'Salesloft', description: 'AI-driven revenue orchestration and sales engagement', categories: ['CRM', 'Sales'], imgSrc: 'https://cdn.simpleicons.org/salesforce', authType: 'oauth', hasActions: true, hasTriggers: true },
  ...
  { slug: 'google_sheets', name: 'Google Sheets', description: 'Create, read, and append spreadsheet data and prospect records', categories: ['Productivity', 'Google'], imgSrc: 'https://cdn.simpleicons.org/googlesheets', authType: 'oauth', hasActions: true, hasTriggers: true, featuredWeight: 79 },
  { slug: 'google_drive', name: 'Google Drive', description: 'Upload, manage, and search documents and campaign files in cloud drive', categories: ['Productivity', 'Google'], imgSrc: 'https://cdn.simpleicons.org/googledrive', authType: 'oauth', hasActions: true, hasTriggers: true, featuredWeight: 78 },
  { slug: 'google_docs', name: 'Google Docs', description: 'Create and edit collaborative online documents and reports', categories: ['Productivity', 'Google'], imgSrc: 'https://cdn.simpleicons.org/googledocs', authType: 'oauth', hasActions: true, hasTriggers: true },
  { slug: 'google_calendar', name: 'Google Calendar', description: 'Schedule meetings, check availability, and manage calendar events', categories: ['Productivity', 'Google'], imgSrc: 'https://cdn.simpleicons.org/googlecalendar', authType: 'oauth', hasActions: true, hasTriggers: true },
  { slug: 'notion', name: 'Notion', description: 'Connect workspace wikis, task boards, and structured databases', categories: ['Productivity'], imgSrc: 'https://cdn.simpleicons.org/notion', authType: 'oauth', hasActions: true, hasTriggers: true, featuredWeight: 77 },
  { slug: 'airtable', name: 'Airtable', description: 'Relational database platform with automations and grid views', categories: ['Productivity', 'Database'], imgSrc: 'https://cdn.simpleicons.org/airtable', authType: 'oauth', hasActions: true, hasTriggers: true, featuredWeight: 76 },
  { slug: 'linear', name: 'Linear', description: 'Issue tracking and project management for software teams', categories: ['Productivity', 'Developer Tools'], imgSrc: 'https://cdn.simpleicons.org/linear', authType: 'oauth', hasActions: true, hasTriggers: true, featuredWeight: 75 },
  { slug: 'asana', name: 'Asana', description: 'Work management and team project tracking platform', categories: ['Productivity'], imgSrc: 'https://cdn.simpleicons.org/asana', authType: 'oauth', hasActions: true, hasTriggers: true },
  { slug: 'monday', name: 'Monday.com', description: 'Customizable work OS for team workflow automation', categories: ['Productivity'], imgSrc: 'https://cdn.simpleicons.org/mondaydotcom', authType: 'oauth', hasActions: true, hasTriggers: true },
  { slug: 'trello', name: 'Trello', description: 'Visual Kanban boards, lists, and cards for project organization', categories: ['Productivity'], imgSrc: 'https://cdn.simpleicons.org/trello', authType: 'oauth', hasActions: true, hasTriggers: true },
  { slug: 'clickup', name: 'ClickUp', description: 'All-in-one productivity platform for tasks, docs, and goals', categories: ['Productivity'], imgSrc: 'https://cdn.simpleicons.org/clickup', authType: 'oauth', hasActions: true, hasTriggers: true },
  { slug: 'jira', name: 'Jira Software', description: 'Agile project management and issue tracking by Atlassian', categories: ['Productivity', 'Developer Tools'], imgSrc: 'https://cdn.simpleicons.org/jira', authType: 'oauth', hasActions: true, hasTriggers: true },
  { slug: 'confluence', name: 'Confluence', description: 'Team knowledge base and collaborative workspace documentation', categories: ['Productivity'], imgSrc: 'https://cdn.simpleicons.org/confluence', authType: 'oauth', hasActions: true, hasTriggers: true },
  { slug: 'coda', name: 'Coda', description: 'All-in-one collaborative doc that brings words, data, and teams together', categories: ['Productivity'], imgSrc: 'https://cdn.simpleicons.org/coda', authType: 'oauth', hasActions: true, hasTriggers: true },
  { slug: 'calendly', name: 'Calendly', description: 'Automated meeting scheduling and availability booking', categories: ['Productivity'], imgSrc: 'https://cdn.simpleicons.org/calendly', authType: 'oauth', hasActions: true, hasTriggers: true },
  ...
  { slug: 'loom', name: 'Loom', description: 'Video messaging for work, screen recording, and asynchronous sharing', categories: ['Productivity', 'Communication'], imgSrc: 'https://cdn.simpleicons.org/loom', authType: 'oauth', hasActions: true, hasTriggers: true },
  { slug: 'dropbox', name: 'Dropbox', description: 'Cloud file storage, backup, and collaborative sharing', categories: ['Productivity'], imgSrc: 'https://cdn.simpleicons.org/dropbox', authType: 'oauth', hasActions: true, hasTriggers: true },
  { slug: 'box', name: 'Box', description: 'Secure content management, workflow, and collaboration', categories: ['Productivity'], imgSrc: 'https://cdn.simpleicons.org/box', authType: 'oauth', hasActions: true, hasTriggers: true },

  // ── AI & Machine Learning ────────────────────────────────────────────────
  { slug: 'openai', name: 'OpenAI (GPT-4o)', description: 'AI text generation, reasoning, embeddings, and structured tool calling', categories: ['AI & ML'], imgSrc: 'https://cdn.simpleicons.org/openai', authType: 'keys', hasActions: true, hasTriggers: true, featuredWeight: 74 },
  { slug: 'anthropic', name: 'Anthropic Claude', description: 'Advanced AI reasoning, code generation, and deep context analysis', categories: ['AI & ML'], imgSrc: 'https://cdn.simpleicons.org/anthropic', authType: 'keys', hasActions: true, hasTriggers: true, featuredWeight: 73 },
  ...
  { slug: 'huggingface', name: 'Hugging Face', description: 'Open source AI models, datasets, and machine learning endpoints', categories: ['AI & ML'], imgSrc: 'https://cdn.simpleicons.org/huggingface', authType: 'keys', hasActions: true, hasTriggers: true },
  ...
  { slug: 'github', name: 'GitHub', description: 'Code hosting, pull requests, issue management, and CI/CD actions', categories: ['Developer Tools'], imgSrc: 'https://cdn.simpleicons.org/github', authType: 'oauth', hasActions: true, hasTriggers: true, featuredWeight: 70 },
  { slug: 'gitlab', name: 'GitLab', description: 'Complete DevOps lifecycle platform with Git repository hosting', categories: ['Developer Tools'], imgSrc: 'https://cdn.simpleicons.org/gitlab', authType: 'oauth', hasActions: true, hasTriggers: true },
  { slug: 'bitbucket', name: 'Bitbucket', description: 'Git code management and continuous delivery by Atlassian', categories: ['Developer Tools'], imgSrc: 'https://cdn.simpleicons.org/bitbucket', authType: 'oauth', hasActions: true, hasTriggers: true },
  { slug: 'postgres', name: 'PostgreSQL', description: 'Powerful open-source object-relational SQL database', categories: ['Database', 'Developer Tools'], imgSrc: 'https://cdn.simpleicons.org/postgresql', authType: 'keys', hasActions: true, hasTriggers: true, featuredWeight: 69 },
  { slug: 'supabase', name: 'Supabase', description: 'Open source Firebase alternative with PostgreSQL, Auth, and Storage', categories: ['Database', 'Developer Tools'], imgSrc: 'https://cdn.simpleicons.org/supabase', authType: 'keys', hasActions: true, hasTriggers: true, featuredWeight: 68 },
  { slug: 'mysql', name: 'MySQL', description: 'Popular open-source relational database management system', categories: ['Database', 'Developer Tools'], imgSrc: 'https://cdn.simpleicons.org/mysql', authType: 'keys', hasActions: true, hasTriggers: true },
  { slug: 'mongodb', name: 'MongoDB', description: 'Document-oriented NoSQL database for high-velocity modern apps', categories: ['Database', 'Developer Tools'], imgSrc: 'https://cdn.simpleicons.org/mongodb', authType: 'keys', hasActions: true, hasTriggers: true },
  { slug: 'redis', name: 'Redis', description: 'In-memory data structure store used as a database, cache, and message broker', categories: ['Database', 'Developer Tools'], imgSrc: 'https://cdn.simpleicons.org/redis', authType: 'keys', hasActions: true, hasTriggers: true },
  { slug: 'docker', name: 'Docker', description: 'Containerization platform to build, share, and run modern applications', categories: ['Developer Tools'], imgSrc: 'https://cdn.simpleicons.org/docker', authType: 'none', hasActions: true, hasTriggers: true },
  { slug: 'kubernetes', name: 'Kubernetes', description: 'Automated container deployment, scaling, and management', categories: ['Developer Tools'], imgSrc: 'https://cdn.simpleicons.org/kubernetes', authType: 'keys', hasActions: true, hasTriggers: true },
  { slug: 'aws', name: 'Amazon Web Services (AWS)', description: 'Cloud computing services including S3, Lambda, DynamoDB, and SQS', categories: ['Developer Tools'], imgSrc: 'https://cdn.simpleicons.org/amazonaws', authType: 'keys', hasActions: true, hasTriggers: true },
  { slug: 'gcp', name: 'Google Cloud Platform (GCP)', description: 'Cloud infrastructure, BigQuery, Cloud Functions, and Vertex AI', categories: ['Developer Tools', 'Google'], imgSrc: 'https://cdn.simpleicons.org/googlecloud', authType: 'oauth', hasActions: true, hasTriggers: true },
  { slug: 'azure', name: 'Microsoft Azure', description: 'Cloud computing platform for building, testing, and managing applications', categories: ['Developer Tools'], imgSrc: 'https://cdn.simpleicons.org/microsoftazure', authType: 'oauth', hasActions: true, hasTriggers: true },
  { slug: 'vercel', name: 'Vercel', description: 'Frontend cloud platform for static and serverless deployments', categories: ['Developer Tools'], imgSrc: 'https://cdn.simpleicons.org/vercel', authType: 'keys', hasActions: true, hasTriggers: true },
  { slug: 'netlify', name: 'Netlify', description: 'Serverless platform to build, deploy, and scale web applications', categories: ['Developer Tools'], imgSrc: 'https://cdn.simpleicons.org/netlify', authType: 'oauth', hasActions: true, hasTriggers: true },
  { slug: 'cloudflare', name: 'Cloudflare', description: 'Web performance, DNS, security, and edge worker computing', categories: ['Developer Tools'], imgSrc: 'https://cdn.simpleicons.org/cloudflare', authType: 'keys', hasActions: true, hasTriggers: true },
  { slug: 'sentry', name: 'Sentry', description: 'Application monitoring and real-time error tracking software', categories: ['Developer Tools'], imgSrc: 'https://cdn.simpleicons.org/sentry', authType: 'keys', hasActions: true, hasTriggers: true },
  { slug: 'datadog', name: 'Datadog', description: 'Cloud-scale observability and security monitoring service', categories: ['Developer Tools'], imgSrc: 'https://cdn.simpleicons.org/datadog', authType: 'keys', hasActions: true, hasTriggers: true },

  // ── E-Commerce & Finance ─────────────────────────────────────────────────
  { slug: 'stripe', name: 'Stripe', description: 'Online payment processing, customer subscriptions, and invoices', categories: ['Finance', 'E-commerce'], imgSrc: 'https://cdn.simpleicons.org/stripe', authType: 'oauth', hasActions: true, hasTriggers: true, featuredWeight: 67 },
  { slug: 'shopify', name: 'Shopify', description: 'E-commerce platform for online stores and retail point-of-sale systems', categories: ['E-commerce', 'Sales'], imgSrc: 'https://cdn.simpleicons.org/shopify', authType: 'oauth', hasActions: true, hasTriggers: true },
  { slug: 'woocommerce', name: 'WooCommerce', description: 'Open-source e-commerce plugin for WordPress', categories: ['E-commerce'], imgSrc: 'https://cdn.simpleicons.org/woocommerce', authType: 'keys', hasActions: true, hasTriggers: true },
  { slug: 'paypal', name: 'PayPal', description: 'Global online payment system and merchant checkout services', categories: ['Finance', 'E-commerce'], imgSrc: 'https://cdn.simpleicons.org/paypal', authType: 'oauth', hasActions: true, hasTriggers: true },
  { slug: 'square', name: 'Square', description: 'Point of sale, credit card payments, and small business banking', categories: ['Finance', 'E-commerce'], imgSrc: 'https://cdn.simpleicons.org/square', authType: 'oauth', hasActions: true, hasTriggers: true },
  { slug: 'webflow', name: 'Webflow', description: 'Visual web design, CMS, and e-commerce platform', categories: ['Developer Tools', 'Marketing'], imgSrc: 'https://cdn.simpleicons.org/webflow', authType: 'oauth', hasActions: true, hasTriggers: true },
  { slug: 'wordpress', name: 'WordPress', description: 'Free and open-source content management system', categories: ['Developer Tools', 'Content & CMS'], imgSrc: 'https://cdn.simpleicons.org/wordpress', authType: 'oauth', hasActions: true, hasTriggers: true },

  // ── Forms & Surveys ──────────────────────────────────────────────────────
  { slug: 'typeform', name: 'Typeform', description: 'Interactive online forms, surveys, and quizzes that people love', categories: ['Forms & Surveys', 'Lead Generation'], imgSrc: 'https://cdn.simpleicons.org/typeform', authType: 'oauth', hasActions: true, hasTriggers: true },
  { slug: 'jotform', name: 'JotForm', description: 'Powerful online form builder with custom branding and payment tools', categories: ['Forms & Surveys'], imgSrc: 'https://cdn.simpleicons.org/jotform', authType: 'oauth', hasActions: true, hasTriggers: true },
