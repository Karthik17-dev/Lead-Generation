...
export const DECKS: readonly DeckDef[] = [
  {
    ...
    description:
      'How Zed contains an agent: one sandbox per session, connector keys the machine never holds, a human gate before anything reaches main, and a record of every action.',
    kind: 'Product',
  ...
  },
  {
    ...
    title: 'Product deck',
    description:
      'The in-depth platform walkthrough — the full Zed surface, from projects and sessions to connectors, channels and change requests.',
    kind: 'Product',
  ...
  },
  {
    ...
    title: 'Sales deck',
    description:
      'The company narrative: where Zed came from, what it is, and why a company runs on a repo and a workforce of agents.',
    kind: 'Sales',
