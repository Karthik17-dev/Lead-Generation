...
const CREDIT_POINTS: { title: string; body: string }[] = [
  ...
  },
  {
    ...
    body: 'Bring your own API key or connect ChatGPT. You pay your model provider directly and keep Zed credits for Agent Computer runtime.',
  },
  {
...
const CREDIT_EXAMPLES: { label: string; body: string }[] = [
  { label: 'Free start', body: '200 credits covers sandbox runtime for early projects and demos.' },
  {
    ...
    body: 'Zed-managed models remain available when you need them. Their token-based usage draws from pooled Team credits.',
  },
  {
    label: 'Team scale',
...
const FAQ: [string, string][] = [
  [
    ...
    'Free includes 200 credits each month for sandbox compute and 1 project. Bring your own API key or connect your ChatGPT subscription for premium access. Managed Claude, GPT, and Gemini on Zed keys are paid.',
  ],
  [
        ...
        <div className="border-border bg-card relative overflow-hidden rounded-sm border text-center">
          <div className="flex grid-cols-12 flex-col-reverse gap-2 md:grid">
            ...
            <div className="col-span-8 mask-y-from-90% mask-x-from-90%">
              <ZedGrid count={45} cols={8} seed={4622} />
            </div>
          </div>
        </div>
      </section>
