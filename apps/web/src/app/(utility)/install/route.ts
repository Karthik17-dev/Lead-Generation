...
// Serves the Zed CLI installer. Hit via:
...
const REPO_URL = 'https://github.com/karthikxa/AI-Management-System';
const REPO_SCRIPT_URL = `${REPO_URL}/blob/main/scripts/install.sh`;
const RAW_SCRIPT_URL = 'https://raw.githubusercontent.com/karthikxa/AI-Management-System/main/scripts/install.sh';
...
function scriptHeaders(): Headers {
  ...
  headers.set('X-Zed-Install-Source', RAW_SCRIPT_URL);
  return headers;
}
