      ...
      <div className="space-y-8">
        <section>
          ...
          <p className="mb-8 text-lg">
            {tHardcodedUi.raw(
              'appHelpCreditsPage.line42JsxTextCreditsAreZedSStandardUnitOfMeasurement',
            )}
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mb-6">
            {tHardcodedUi.raw('appHelpCreditsPage.line49JsxTextZedUsesTwoTypesOfCreditsToGive')}
          </p>
          ...
          <Alert className="mb-8">
            ...
            <AlertDescription>
              ...
              {tHardcodedUi.raw(
                'appHelpCreditsPage.line103JsxTextWhenYouUseZedExpiringCreditsAreConsumed',
              )}
            </AlertDescription>
          </Alert>
        </section>
        ...
        <section>
          ...
          <div className="mb-8 flex flex-col gap-3 sm:flex-row">
            <Button
              variant="outline"
              className="gap-2"
              onClick={() => (window.location.href = 'mailto:hey@zed.com')}
            >
