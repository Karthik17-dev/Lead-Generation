...
/**
 * The live star count on `karthikxa/AI-Management-System`, read from `/api/github-stars`.
 *
 ...
 * "GitHub stars on karthikxa/AI-Management-System" — at 72px on the home page. A failure now
 ...
 * `karthikxa/AI-Management-System` server-side. They are kept so existing call sites compile.
 */
