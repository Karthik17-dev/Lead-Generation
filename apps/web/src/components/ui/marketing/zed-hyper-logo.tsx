...
import { buildCells, type Cell, CELL_FONT_SIZE, VIEW_H, VIEW_W } from './zed-hyper-logo.cells';
...
interface ZedHyperLogoProps extends Omit<MotionProps, 'children'> {
  className?: string;
  size?: number;
  duration?: number;
  delay?: number;
