...
import { useImpersonation, useStopImpersonation } from '@zed/sdk/react';
...
export function ImpersonationBanner() {
  ...
  return (
    ...
    >
      <div
        className={cn(
          'bg-background border-zed-orange/30 pointer-events-auto flex max-w-[calc(100vw-2rem)]',
          'items-center gap-3 rounded-[0.64rem] border py-2 pr-2 pl-3 shadow-lg',
        )}
      >
        <span className="bg-zed-orange/10 text-zed-orange flex size-7 shrink-0 items-center justify-center rounded-sm">
