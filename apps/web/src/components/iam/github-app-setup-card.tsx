...
// same job.
//
// On the hosted Zed deployment (source 'env') the App is configured by the
      ...
      <CardHeading
        ...
        description={
          status.configured
            ...
            : 'Every Zed project is a git repository the server creates and pushes to on your behalf. Connect GitHub once here to enable projects.'
        }
        action={
          reconfiguring ? (
            <Button
      ...
      {showSetup ? (
        <div className="space-y-3">
          ...
          <RadioGroup
            ...
            aria-label="How Zed authenticates to GitHub"
                      ...
                      <div className="space-y-3 px-4 py-4">
                        ...
                        <dl className="space-y-2 text-xs">
                          ...
                          <div className="sm:flex sm:gap-3">
                            ...
                            <dd className="text-foreground leading-relaxed">
                              All repositories — Zed creates a new repo per project, so a fixed
        ...
        <div className="bg-popover overflow-hidden rounded-md border">
          {/* Identity: who owns the repositories Zed is about to create. */}
...
function CardHeading({
  badges,
  description = 'Every Zed project is a git repository the server creates and pushes to on your behalf.',
  action,
}: {
