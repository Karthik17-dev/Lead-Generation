...
export function TunnelOverview({ canWrite = false }: { canWrite?: boolean }) {
  return (
    <CustomizeSectionWrapper
      ...
      description="Pair Macs, Windows PCs, and Linux machines through the secure Zed Agent Tunnel. Open a machine to control its permissions and review its audit history."
    >
