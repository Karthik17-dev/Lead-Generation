...
const MANIFEST: { id: string; line: string; tone?: 'muted' | 'accent' }[] = [
  { id: 'version', line: 'zed_version: 2' },
  { id: 'default-agent', line: 'default_agent: zed' },
  { id: 'agents', line: 'agents:' },
  { id: 'zed-agent', line: '  zed:' },
  { id: 'zed-connectors', line: '    connectors: all' },
  { id: 'zed-secrets', line: '    secrets: all' },
  { id: 'zed-skills', line: '    skills: all' },
        ...
        <Panel title="zed.yaml" count="omit a grant and it is none">
          <div className="bg-background px-4 py-3">
            <pre
              ...
              tabIndex={0}
              aria-label="Zed project manifest"
