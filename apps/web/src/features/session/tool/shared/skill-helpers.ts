 ...
 * to `<configDir>/skills/<name>/` (zed-sandbox-agent-server), that configDir
 * falls back to `.zed/opencode` (`resolveOpencodeConfigDir`), and the product
 ...
 *   2. `.zed/opencode/skills/<name>/`, where this product installs skills;
