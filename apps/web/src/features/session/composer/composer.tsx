...
import type { Agent, Command, MessageWithParts, ProviderListResponse } from '@zed/sdk/react';
      ...
      */}
      ...
      <div
        ...
        className={cn(
          ...
          cardClassName,
          isDragOver && 'border-zed-blue/80 ring-primary/40 border opacity-30 ring',
