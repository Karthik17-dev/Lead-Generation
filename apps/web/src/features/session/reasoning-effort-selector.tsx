...
import { modelKeyToWire, useGatewayRoutingPolicy } from '@zed/sdk/react';
import {
  CaretDownIcon,
  CellSignalFullIcon,
  CellSignalHighIcon,
...
import { Zed } from '../icon/icons/zed';
...
/**
 * Same stop list as `ZED_BULLET_GRADIENT` — expressed as a Tailwind
 ...
 *
 * `max` / `full` paint the Zed rainbow through the icon via
