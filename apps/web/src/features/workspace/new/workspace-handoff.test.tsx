...
/** The `<svg>` the Zed mark renders into, cells and all. */
...
describe('WorkspaceHandoff', () => {
  ...
  test('the mark is the canonical Zed logo, breathing rather than spinning', () => {
    expect(source).toContain("from '@/components/ui/zed-logo'");
