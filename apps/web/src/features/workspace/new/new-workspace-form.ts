 ...
 * workspace has a repo, and a name-only create has to choose one. Zed
 ...
 *
 * `account_role` is optional on `ZedAccount` — an account with no role at
 ...
 */
export function filterCreatableAccounts(accounts: ZedAccount[]): ZedAccount[] {
