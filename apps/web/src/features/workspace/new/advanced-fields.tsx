...
const SOURCE_DESCRIPTIONS: Record<RepositorySource, string> = {
  managed: 'Zed creates and manages a private repository for this workspace.',
...
function GitHubSourceNote({ accountId }: { accountId: string | null }) {
  ...
  return (
    <p className="text-muted-foreground text-xs">
      Only Zed-managed repositories can be created here for now. Choose Zed managed to
      continue, or{' '}
