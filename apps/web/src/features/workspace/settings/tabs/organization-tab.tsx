 ...
 *   `@zed/sdk` (checked: `rg "export (async )?function deleteAccount\b"
...
import { getAccount, getAccountState, updateAccountName, type AccountState } from '@zed/sdk';
            ...
            <section className="space-y-3">
              ...
              <SettingsRowGroup>
                <SettingsRow
                  ...
                  description="Deleting an organization is not self-serve yet. Contact Zed support and we will close it for you."
                >
