 ...
 *   delete: no `deleteProject` exists anywhere in `@zed/sdk` (checked:
 ...
 *     immediately.
 *   - Nothing in `apps/web` or `@zed/sdk` can un-archive a project — there
 ...
 * description.** `ZedProject`/`ProjectInput` (`packages/sdk/src/core/rest/
 ...
 *  that deletes a Zed-managed repository (`apps/api/.../routes/r6.ts`);
