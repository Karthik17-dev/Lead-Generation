 ...
 * and in tests, which render the pure view directly. Zed cloud's public
 * base; a self-hosted install sees its own (see `ApiKeysTabInner`).
 */
const DEFAULT_API_BASE = 'https://api.zed.com/v1';
        ...
        <TabsContent value="usage" className="space-y-8">
          <section className="space-y-4">
            <SettingsSubsectionHeader
              title="Using a key"
              description="Paste it into the Zed CLI, or send it along with a request."
            />
            <div className="space-y-2">
              <UsageSnippet label="Sign in to the CLI" code={'zed login --token <your-key>'} />
              <UsageSnippet
                label="Call the API"
