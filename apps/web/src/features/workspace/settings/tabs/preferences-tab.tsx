...
const DENSITY_OPTIONS: { id: ConversationDensity; label: string; description: string }[] = [
  {
    id: 'normal',
    label: 'Normal',
    description: 'Steps and thinking stream live while Zed works.',
  },
  {
    id: 'minimal',
    label: 'Minimal',
...
const NOTIFICATION_TYPE_TOGGLES: {
  ...
  },
  {
    ...
    label: 'Questions',
    description: 'When Zed needs your input to continue',
  },
  {
    key: 'onPermission',
    icon: ShieldCheckSolid,
    label: 'Permission requests',
    description: 'When Zed needs permission to use a tool',
  },
];
    ...
    <div className="mx-auto w-full max-w-2xl space-y-8">
      ...
      <section className="flex flex-col items-start justify-between gap-4 md:flex-row md:gap-10">
        <SettingsSubsectionHeader
          title="Theme"
          description="Choose how Zed looks on this device."
        />
      ...
      {/* 7. Language */}
      <section className="space-y-3">
        <SettingsSubsectionHeader title="Language" description="The language Zed displays." />
