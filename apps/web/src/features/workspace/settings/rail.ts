...
const MARKETPLACE_ITEM: RailItem = {
  ...
  label: 'Marketplace',
  icon: Store,
  description: 'Agents and skills published by the Zed community.',
};
...
const VOICE_ITEM: RailItem = {
  ...
  // here ("How Zed sounds when it speaks and listens") describes picking a
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: 'Snapshots',
        icon: Stack,
        // The pane opened on a log of `zed-tpl-…` strings with nothing
        ...
        description:
          'Every session starts on a machine Zed prepared in advance. This is the record of each time it prepared one.',
        docsHref: '/docs/work/runtime',
      },
    ],
  },
    ...
    items: [
      {
        ...
        description: 'Let the Zed CLI, a script, or a CI job use this workspace.',
      },
      {
        tab: 'experimental',
        label: 'Experimental',
