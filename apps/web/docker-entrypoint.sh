#!/bin/sh
# ╔══════════════════════════════════════════════════════════════════════════════╗
# ║  Zed Frontend — Docker Entrypoint                                       ║
# ║                                                                            ║
...
# Support both NEXT_PUBLIC_* (legacy) and ZED_PUBLIC_* (current) naming.
RUNTIME_SUPABASE_URL="${NEXT_PUBLIC_SUPABASE_URL:-${ZED_PUBLIC_SUPABASE_URL:-}}"
RUNTIME_ANON_KEY="${NEXT_PUBLIC_SUPABASE_ANON_KEY:-${ZED_PUBLIC_SUPABASE_ANON_KEY:-}}"
RUNTIME_BACKEND_URL="${NEXT_PUBLIC_BACKEND_URL:-${ZED_PUBLIC_BACKEND_URL:-}}"
RUNTIME_APP_URL="${NEXT_PUBLIC_APP_URL:-${ZED_PUBLIC_APP_URL:-${NEXT_PUBLIC_URL:-}}}"
RUNTIME_BILLING="${NEXT_PUBLIC_BILLING_ENABLED:-${ZED_PUBLIC_BILLING_ENABLED:-false}}"
...
# e.g. http://127.0.0.1:54321 -> https://e2e-test.zed.cloud (not http://https://...)
