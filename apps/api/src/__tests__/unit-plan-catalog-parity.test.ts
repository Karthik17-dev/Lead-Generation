...
// tiers.ts reads config.INTERNAL_ZED_ENV at module scope (per-environment
...
mock.module('../config', () => ({
  config: {
    ...
    ZED_LLM_ROUTER_REQS_PER_MIN_FREE: FREE_REQS_PER_MIN,
    ZED_LLM_ROUTER_REQS_PER_MIN_PAID: PAID_REQS_PER_MIN,
  },
}));
