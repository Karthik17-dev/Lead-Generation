...
const EDITOR_EXTRAS: readonly string[] = [
  ...
  // Zed Apps: creating/resizing an App and shipping a version are
 ...
 *  drive Zed. What it CANNOT do is customize the project (edit settings,
...
const PROJECT_MEMBER_BASELINE: readonly string[] = [
  ...
  // Zed Apps: a member sees the Apps the App access policy shares with
