...
import { GrantSecretToAgentInputSchema, GrantSecretToAgentResultSchema } from '@zed/api-contract';
...
// the warning was a dead end that only a hand-edit of zed.yaml could clear.
//
