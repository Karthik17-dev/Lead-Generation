 ...
 * held a completed backup). The Zed-side finding this file exists for:
 *
 ...
 * Zed kept advertising it as resumable until a human happened to open it.
 *
 * Measured on prod 2026-08-13: 16,243 parked rows had never been re-verified,
 * and 16 of them were already dead provider-side without Zed knowing.
 */
