    ...
    inputSchema: {
      ...
      properties: {
        ...
        headers: {
          type: 'object',
          description:
            'Non-secret request headers, { "content-type": "application/json" }. Omit the credential header — Zed adds it.',
        },
        body: {
          type: 'string',
