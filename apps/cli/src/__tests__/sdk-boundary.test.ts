...
describe('scanSource raw-zed-fetch', () => {
  ...
  test('allows the GitHub releases API', () => {
    const source = "await fetch('https://api.github.com/repos/karthikxa/AI-Management-System/releases/latest')";
  ...
  test('reports no violation for a planted allow-listed fetch', () => {
    ...
    writeFileSync(
      ...
      [
        ...
        "  return fetch('https://api.github.com/repos/karthikxa/AI-Management-System/releases/latest');",
        '}',
        'export { createZed };',
        '',
      ].join('\n'),
