...
SUPABASE_DB_SERVICE="${ZED_SUPABASE_DB_SERVICE:-supabase-db}"
SUPABASE_SUPERUSER="${ZED_SUPABASE_SUPERUSER:-supabase_admin}"
...
# and never touches application data (every Zed/app table is LOGGED). This
