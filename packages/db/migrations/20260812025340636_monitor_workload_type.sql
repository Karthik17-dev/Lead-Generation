...
-- 20260807015000000).
ALTER TABLE "zed"."sandbox_compute_sessions" DROP CONSTRAINT "sandbox_compute_sessions_workload_type_check";--> statement-breakpoint
ALTER TABLE "zed"."sandbox_compute_sessions" ADD CONSTRAINT "sandbox_compute_sessions_workload_type_check" CHECK ("zed"."sandbox_compute_sessions"."workload_type" IN ('session', 'app', 'monitor')) NOT VALID;