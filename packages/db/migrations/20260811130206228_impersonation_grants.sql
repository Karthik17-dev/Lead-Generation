...
CREATE TABLE "zed"."impersonation_grants" (
...
CREATE INDEX "idx_impersonation_grants_admin_expires" ON "zed"."impersonation_grants" USING btree ("admin_user_id","expires_at");--> statement-breakpoint
CREATE INDEX "idx_impersonation_grants_target" ON "zed"."impersonation_grants" USING btree ("target_account_id");