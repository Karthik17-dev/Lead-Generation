...
ALTER TABLE "zed"."credit_accounts" ADD COLUMN "entitlement_overrides" jsonb DEFAULT '{}'::jsonb NOT NULL;

COMMENT ON COLUMN "zed"."credit_accounts"."entitlement_overrides" IS
...
--
-- backfill-safe: zed.credit_accounts — 12 rows updated out of 231,564 in
