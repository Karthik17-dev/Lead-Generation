...
function buildPtyOutput(
  ...
  return `<zed_system type="pty-output" source="opencode-pty">\n${inner}\n</zed_system>`
}
...
function buildPtyFailure(type: string, err: unknown): string {
  ...
  return `<zed_system type="${type}" source="opencode-pty">\n<pty_failed>\n${message}\n</pty_failed>\n</zed_system>`
}
      ...
      pty_spawn: tool({
        ...
        async execute(args, ctx) {
          return recoverPtyTool('pty-spawn', async () => {
            ...
            return `<zed_system type="pty-spawn" source="opencode-pty">\n<pty_spawned>\n${inner}\n</pty_spawned>\n</zed_system>`
          })
        },
      }),
        ...
        async execute() {
          return recoverPtyTool('pty-list', async () => {
            ...
            if (sessions.length === 0) {
              return `<zed_system type="pty-list" source="opencode-pty">\n<pty_list>\nNo active PTY sessions.\n</pty_list>\n</zed_system>`
            }
      ...
      pty_kill: tool({
        ...
        async execute(args) {
          return recoverPtyTool('pty-kill', async () => {
            ...
            return `<zed_system type="pty-kill" source="opencode-pty">\n${inner}\n</zed_system>`
          })
        },
      }),
    },
