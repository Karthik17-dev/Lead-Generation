...
/**
 * Mirror a runtime title change straight into the cached Zed session reads
 ...
 * ~20s after the prompt, so the refetch `refetchZedSessionMirrors` fires
 ...
 */
export function patchZedSessionTitleMirrors(
  queryClient: QueryClient,
  projectId: string | null,
