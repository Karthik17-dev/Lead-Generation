      ...
      fetch(request) {
          ...
          return Response.json(
            {
              ...
              verificationUrl: 'https://dev.zed.com/tunnel/authorize/TEST-0001',
        ...
        if (request.method === 'GET' && url.pathname.endsWith('/TEST-0001/status')) {
          ...
          return Response.json({
            ...
            token: 'zed_tnl_ABCDEFGHIJKLMNOPQRSTUVWXYZ123456',
          ...
          return Response.json(
            {
              ...
              deviceSecret: 'ABCDEFGHIJKLMNOPQRSTUVWXYZ123456',
              verificationUrl: 'https://dev.zed.com/tunnel/authorize/TEST-0002',
              expiresAt: new Date(Date.now() + 60_000).toISOString(),
              pollIntervalMs: 250,
            },
            { status: 201 },
