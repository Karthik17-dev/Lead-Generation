      ...
      const result = await probeCredentials(
        {
          ...
          token: 'zed_tnl_AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA',
          wsPath: '/ws',
        } as never,
        { timeoutMs: 5_000 },
      );
      ...
      fetch(request) {
          ...
          return Response.json(
            {
              ...
              verificationUrl: 'https://dev.zed.com/tunnel/authorize/ZERO-0001',
        ...
        if (request.method === 'GET' && url.pathname.endsWith('/ZERO-0001/status')) {
          return Response.json({
            ...
            token: 'zed_tnl_BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB',
            capabilities: [],
          });
        }
